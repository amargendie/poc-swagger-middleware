...
/**
 * Retrieves nameProperties.
 *
 * @param    {idsPath}
 * @returns {object}
 */
exports.getNameProperties = function(filePath) {
  var fs = require('fs');
 var nameProperties = ['id', 'key', 'slug', 'code', 'number', 'num', 'nbr', 'username', 'name'];
 var ids = JSON.parse(fs.readFileSync(filePath, 'utf8'));
  return nameProperties.concat(ids.ids);;
};
